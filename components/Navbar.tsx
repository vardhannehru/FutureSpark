            ...
            >
              ...
              <Link to="/" className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0 leading-tight">
                  <div className="font-heading font-extrabold text-slate-900 text-[18px] sm:text-[22px] md:text-[26px]">
                    Future Spark
                  </div>
                  <div className="text-slate-600 text-[13px] sm:text-[15px] md:text-[17px] font-semibold truncate">
